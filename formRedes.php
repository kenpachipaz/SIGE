...
<html>
    ...
    <body>
        <div id="principal">
            <div id="fomulario">
                <form name="formulario" action="registro.php" method="POST" onSubmit="return validaSelect(this, 2);">
                    <table>
                        <tr>
                            <td colspan="2">
                                <?php 
                       ...
                       <tr>
                        ...
                        <tr style="display:none;">
                            <td><input type="text" data-type="input-textbox" id="area" name="area" size="18" value="2"/></td>
                        </tr>
                        <tr>
                            <td>CARGO:</td>
                            <td>
                                <select name="cargoRedes" onChange="verCoordinadores(this.form,1);">
                        ...
                        <tr>
                            <td>COORDINADOR: </td>
                            <td>
                                <select id="coordiSelect" name="coordinadorRed" disabled>
                                    <option value="nada">---Seleccione coordinador---</option>
                                    <?php 
                                        $query="SELECT cvecoord, capp, capm, cnombre FROM dtperscoor WHERE cvecoord=(SELECT cvecoord FROM coordinadores WHERE carea='Redes')";
                                        $resultado=mysql_query($query);
                                        while($row=mysql_fetch_array($resultado)){
